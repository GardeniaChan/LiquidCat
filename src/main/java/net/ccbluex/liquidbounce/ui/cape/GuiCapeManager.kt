...
object GuiCapeManager : GuiScreen() {
    ...
    val FDP_CAPE = loadCapeFromResource("Cape","assets/minecraft/CAT/cape/cape.png")
    val FDP_CAPE_1=loadCapeFromResource("Cape 1","assets/minecraft/CAT/cape/cape1.png")
    val FDP_CAPE_2=loadCapeFromResource("Cape 2","assets/minecraft/CAT/cape/cape2.png")
    val FDP_CAPE_3=loadCapeFromResource("Cape 3","assets/minecraft/CAT/cape/cape3.png")
    val FDP_CAPE_4=loadCapeFromResource("Cape 4","assets/minecraft/CAT/cape/cape4.png")
    val FDP_CAPE_5=loadCapeFromResource("Cape 5","assets/minecraft/CAT/cape/cape5.png")
    val FDP_CAPE_6=loadCapeFromResource("Cape 6","assets/minecraft/CAT/cape/cape6.png")
    val FDP_CAPE_7=loadCapeFromResource("Cape 7","assets/minecraft/CAT/cape/cape7.png")
    val FDP_CAPE_8=loadCapeFromResource("Cape 8","assets/minecraft/CAT/cape/cape8.png")
    val FDP_CAPE_9=loadCapeFromResource("Cape 9","assets/minecraft/CAT/cape/cape9.png")
    val FDP_CAPE_10=loadCapeFromResource("Cape 10","assets/minecraft/CAT/cape/cape10.png")
    var nowCape:Cape?=FDP_CAPE
    val capeList=mutableListOf<Cape>()

    init {
        capeList.add(FDP_CAPE)
        ...
        for(file in LiquidBounce.fileManager.capesDir.listFiles()){
            if(file.isFile&&!file.name.equals(jsonFile.name)){
                try {
                    ...
                    ClientUtils.getLogger().error("Occurred an error while loading cape from file: ${file.name}")
                    e.printStackTrace()
                }
            }
        }
