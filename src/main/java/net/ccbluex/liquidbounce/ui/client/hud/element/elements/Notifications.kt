...
class Notification(
    ...
    val width = 100.coerceAtLeast(
        Fonts.font40.getStringWidth(this.title)
    ...
    fun drawNotification(index: Int): Boolean {
        ...
        RenderUtils.drawCircleRect(-20F, 0F, 95F,30F,8F,Color(0,0,0,50).rgb)
        Fonts.font40.drawString(title, 7F, 4F, -1)
        Fonts.font40.drawString(content, 7F, 17F, -1)
