...
//            System.out.println(potionData.translate.getY());
            ...
            Fonts.font35.drawString(name + " " + intToRomanByGreedy(potionEffect.getAmplifier() + 1), 29F, posY - mc.fontRendererObj.FONT_HEIGHT, realpha.reAlpha(Colors.WHITE.c, 0.8F));
