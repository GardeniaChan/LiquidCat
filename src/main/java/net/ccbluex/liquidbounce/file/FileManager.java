...
public class FileManager extends MinecraftInstance {
    ...
    public final File dir = new File(mc.mcDataDir, "猫猫召唤");
    ...
    public void main(String[] a) throws IOException{
       // FileInputStream in = new FileInputStream("D:/Desktop/Background.png");
       // FileOutputStream out= new FileOutputStream("D:/Background.png");
