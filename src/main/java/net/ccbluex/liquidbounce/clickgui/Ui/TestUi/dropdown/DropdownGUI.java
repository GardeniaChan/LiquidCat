...
public class DropdownGUI extends GuiScreen {
   ...
   private final ResourceLocation xy = new ResourceLocation("liquidbounce/bigpng/xingye.png");
    public DropdownGUI() {
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        if (ClickGUI.imageValue.getValue()){
            RenderUtils.drawImage(xy, ClickGUI.imagex.get(), ClickGUI.imagey.get(),100,150);
        } else {
