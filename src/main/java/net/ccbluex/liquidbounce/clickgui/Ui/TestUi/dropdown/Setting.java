package net.ccbluex.liquidbounce.clickgui.Ui.TestUi.dropdown;
...
public class Setting {
    ...
    public void drawScreen(int mouseX, int mouseY) {
        ...
        if (setting instanceof FloatValue) {
            ...
            Fonts.SFBOLD.SFBOLD_18.SFBOLD_18.drawString(numberValue.getName() + " " + rounded, module.tab.getPosX() + 4, y + 5.5f, 0xffffffff, true);
        ...
        if (setting instanceof IntegerValue) {
            ...
            RenderUtils.drawRect(module.tab.getPosX() + 1, y + 3, module.tab.getPosX() + 99, y + 14, new Color(0, 0, 0, 50).getRGB());
            RenderUtils.drawRect(module.tab.getPosX() + 1, y + 3, module.tab.getPosX() + 1 + 98 * percent, y + 14, ClickGUI.generateColor());
            Fonts.SFBOLD.SFBOLD_18.SFBOLD_18.drawString(integerValue.getName() + " " + rounded, module.tab.getPosX() + 4, y + 5.5f, 0xffffffff, true);
        ...
        if (setting instanceof BoolValue) {
            ...
            Fonts.SFBOLD.SFBOLD_18.SFBOLD_18.drawString(boolValue.getName(), module.tab.getPosX() + 4, y + 5.5f,
                    new Color(227, 227, 227, 255).getRGB(), true);

        }
        if (setting instanceof ListValue) {
            final ListValue listValue = (ListValue) setting;
            Fonts.SFBOLD.SFBOLD_17.SFBOLD_17.drawString(listValue.getName(), module.tab.getPosX() + 3, (float) (y + 6),
                    0xffffffff, true);
            Fonts.SFBOLD.SFBOLD_17.SFBOLD_17.drawString(listValue.get().toUpperCase(),
 ...
 */
       ...
       if (setting instanceof TextValue){
        ...
        RenderUtils.drawRect(module.tab.getPosX() + 6, y + 16, module.tab.getPosX() + 84, y + 16.5, new Color(195, 195, 195, 220).getRGB());
           Fonts.SFBOLD.SFBOLD_16.SFBOLD_16.drawString(textValue.getName(), module.tab.getPosX() + 5.5f, y + 1.5f, new Color(227, 227, 227, 255).getRGB());

        if (Fonts.SFBOLD.SFBOLD_16.SFBOLD_16.stringWidth(s) > 65) {
            Fonts.SFBOLD.SFBOLD_16.SFBOLD_16.drawString(Fonts.SFBOLD.SFBOLD_16.SFBOLD_16.trimStringToWidth(s, 78, true), module.tab.getPosX() + 6, y + 10, 0xFFFFFFFF);
        } else {
            Fonts.SFBOLD.SFBOLD_16.SFBOLD_16.drawString(s, module.tab.getPosX() + 6, y + 10, 0xFFFFFFFF);
        }
