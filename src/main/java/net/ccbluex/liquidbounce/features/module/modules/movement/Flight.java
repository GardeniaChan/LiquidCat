...
public class Flight extends Module {
    ...
    private double launchX = 0.0;
    private double launchY = 0.0;
    private double launchZ = 0.0;
    private double launchYaw = 0f;
    private double launchPitch = 0f;
    ...
    public void onBB(final BlockBBEvent event) {
        ...
        if (mode.equalsIgnoreCase("Verus5")) {
    ...
    public void onJump(final JumpEvent e) {
        ...
        if (mode.equalsIgnoreCase("Verus5") || mode.equalsIgnoreCase("Hypixel") || mode.equalsIgnoreCase("BoostHypixel") ||
