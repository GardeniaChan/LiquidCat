...
@ModuleInfo(name = "LegitAura", category = ModuleCategory.COMBAT, description="safe aura")
class LegitAura : Module() {
    ...
    private val rotationModeValue = ListValue("RotationMode", arrayOf("None","LiquidBounce","Hypixel","LockView", "OldMatrix"), "LiquidBounce")
    // Bypass
    ...
    private val attackTimingValue = ListValue("AttackTiming", arrayOf("All", "Pre", "Post", "Both"), "All")// Turn Speed
