...
@ModuleInfo(name = "AutoGG", category = ModuleCategory.PLAYER,description = "mmmm")
class AutoPlay : Module() {
    private var clickState = 0
    private val modeValue = ListValue("Server", arrayOf("RedeSky", "BlocksMC", "Minemora", "Hypixel", "HuaYuTing","HYTSW"), "HuaYuTing")
    private val delayValue = IntegerValue("Delay", 3, 0, 7)
