...
import net.ccbluex.liquidbounce.clickgui.Ui.TestUi.dropdown.DropdownGUI;
import net.ccbluex.liquidbounce.event.EventTarget;
import net.ccbluex.liquidbounce.event.PacketEvent;
import net.ccbluex.liquidbounce.features.module.Module;
import net.ccbluex.liquidbounce.features.module.ModuleCategory;
import net.ccbluex.liquidbounce.features.module.ModuleInfo;
import net.ccbluex.liquidbounce.ui.client.ChocolateClickGui;
import net.ccbluex.liquidbounce.ui.client.ClickUi.ClickyUI;
...
public class ClickGUI extends Module {
    ...
    public static final BoolValue imageValue = new BoolValue("image",false);
    public static final IntegerValue imagex = new IntegerValue("imagex",50,0, sr.getScaledWidth());
    public static final IntegerValue imagey = new IntegerValue("imagey", 50,0,sr.getScaledHeight());
    private static final ListValue modeValue = new ListValue("Mode", new String[]{"ClickGui","Novoline"},"ClickGui");
